...
exports.i18nValidationPip = exports.translateErrors = void 0;
...
function translateErrors(validationErrors) {
    ...
    const errorsFlattened = errors.reduce((data, errors) => {
        data.push(...errors);
        return data;
    }, []);
    return new common_1.UnprocessableEntityException(errorsFlattened);
}
exports.translateErrors = translateErrors;
function parserErrors(error) {
...
const i18nValidationPip = (options) => new common_1.ValidationPipe(Object.assign(Object.assign({}, options), { exceptionFactory: translateErrors }));
exports.i18nValidationPip = i18nValidationPip;
//# sourceMappingURL=i18n.validation-pipe_old.js.map