...
export declare class ProductService {
    ...
    findSimilarProducts(productId: string): Promise<(import("mongoose").Document<unknown, {}, import("../models/product.model").Product & Document> & Omit<import("../models/product.model").Product & Document & {
        _id: import("mongoose").Types.ObjectId;
    }, never>)[]>;
}
