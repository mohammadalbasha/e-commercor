...
export declare class ProductSellerController {
    ...
    listAll(categoryId: string, requestQuery: any, storeId: string): Promise<{
    ...
    listOne(productId: string, storeId: string): Promise<{
        categoryName: string;
    ...
    updateOne(productId: string, data: UpdateProductDto, storeId: string): Promise<string>;
    deleteOne(productId: string, data: UpdateProductDto, storeId: string): Promise<string>;
}
